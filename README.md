# ![Node/Express/Mongoose VerseJAM API


> ### Example Node (Express + Mongoose) codebase containing real world examples (CRUD, auth, advanced patterns, etc) that adheres to the [VerseJAM](https://github.com/ethic0/VerseJAM-Angular7-frontend) API spec.
